...
<html>
  <head>
    ...
    <title>Επεξεργασία Εγγράφου μαθήματος</title>
    </head>
<body>
    ...
    <h1> Έγγραφα </h1>
      ...
      <div class="container">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <input class="inputCom" type="text" id="title" name="title" value="<?php echo $title?>" required>

          <label for="description" style="font-size: 130%">Description</label>
          <input class="inputCom" type="text" id="description" name="description" value="<?php echo $description?>" required>

          <label for='file'>Select File </label>
         <input type="file" id='file' name="file" value="<?php echo $filepath?>" accept=".doc,.docx" required>

          <input class="submitCom" type="submit" name="update_Doc" value="Submit">
          </form>
      </div>
    </body>
</html>
